  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050a0e] px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* メインの斜め光線（左下→右上） */}
        <div
          className="absolute -left-[20%] top-[10%] h-[200px] w-[140%] rotate-[-35deg] bg-gradient-to-r from-transparent via-teal-500/8 to-transparent blur-[60px]"
        />
        <div
          className="absolute -left-[10%] top-[30%] h-[150px] w-[130%] rotate-[-35deg] bg-gradient-to-r from-transparent via-cyan-400/6 to-transparent blur-[80px]"
        />
        <div
          className="absolute -left-[15%] top-[55%] h-[180px] w-[140%] rotate-[-35deg] bg-gradient-to-r from-transparent via-emerald-500/7 to-transparent blur-[70px]"
        />

        {/* 補助グロー */}
        <div className="absolute left-[10%] top-[20%] h-[400px] w-[400px] rounded-full bg-teal-900/15 blur-[120px]" />
        <div className="absolute bottom-[10%] right-[15%] h-[350px] w-[350px] rounded-full bg-cyan-900/10 blur-[100px]" />
        <div className="absolute left-[50%] top-[60%] h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-emerald-900/8 blur-[90px]" />
        ...
        {/* 細い光線ライン */}
        <div className="absolute -left-[5%] top-[40%] h-[1px] w-[60%] rotate-[-35deg] bg-gradient-to-r from-transparent via-teal-400/20 to-transparent" />
        <div className="absolute left-[30%] top-[20%] h-[1px] w-[50%] rotate-[-35deg] bg-gradient-to-r from-transparent via-cyan-400/15 to-transparent" />
        <div className="absolute left-[10%] top-[65%] h-[1px] w-[55%] rotate-[-35deg] bg-gradient-to-r from-transparent via-emerald-400/15 to-transparent" />
      </div>
